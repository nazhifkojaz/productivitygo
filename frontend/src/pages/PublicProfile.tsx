...
import { Swords, ArrowLeft, Loader, Calendar, TrendingUp } from 'lucide-react';
...
export default function PublicProfile() {
    ...
    return (
        <div className="min-h-screen bg-[#E8E4D9] neo-grid-bg text-black font-sans p-4 md:p-8 pb-24">
                ...
                <div className="bg-white border-4 border-black shadow-[6px_6px_0_0_#000] p-6">
                    ...
                    <div className="space-y-3">
                        {profile.match_history.length > 0 ? (
                            profile.match_history.map((match: any, i: number) => (
                                <MatchHistoryItem
                                    key={match.id || `pub-${i}`}
                                    match={match}
                                />
            ...
            {/* Challenge Modal */}
            <NeoModal isOpen={showChallengeModal} onClose={() => setShowChallengeModal(false)}>
