// Loading Skeleton Components - Design 1
// Provides content-aware loading states with new design system
    ...
    return (
        <div className="animate-pulse">
            <div className="flex flex-col md:flex-row items-center gap-8">
                {/* Avatar skeleton */}
                <div className="w-32 h-32 bg-gray-200 border-3 border-black" />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                {[1, 2, 3, 4].map(i => (
                    <div key={i} className="bg-gray-50 border-3 border-black p-4">
            ...
            {Array.from({ length: count }).map((_, i) => (
                <div key={i} className="bg-white border-3 border-black p-4 flex items-center justify-between animate-pulse">
                    <div className="flex items-center gap-4">
                        {/* Avatar skeleton */}
                        <div className="w-12 h-12 bg-gray-200 border-3 border-black" />
                        <div>
                            {/* Username skeleton */}
                    ...
                    {/* Button skeleton */}
                    <div className="h-10 w-24 bg-gray-200 border-3 border-black" />
                </div>
            ))}
        </div>
    );
...
export function BattleCardSkeleton({ count = 2 }: { count?: number }) {
    return (
        <div className="space-y-4">
            {Array.from({ length: count }).map((_, i) => (
                <div key={i} className="bg-white border-3 border-black p-6 animate-pulse">
                    {/* Header */}
                    ...
                    <div className="flex gap-2">
                        <div className="h-10 bg-gray-200 border-3 border-black flex-1" />
                        <div className="h-10 bg-gray-200 border-3 border-black flex-1" />
                    </div>
                </div>
            ))}
...
export function DashboardSkeleton() {
    return (
        <div className="min-h-screen bg-[#E8E4D9] p-4 md:p-8 pb-24 animate-pulse">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white border-4 border-black shadow-[6px_6px_0_0_#000] p-6 md:p-8">
                    <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
                        <div className="w-24 h-24 bg-gray-200 border-4 border-black" />
                        <div className="text-center md:text-left flex-1">
                    ...
                    <div className="space-y-2">
                        {[1, 2, 3].map(i => (
                            <div key={i} className="h-12 bg-gray-200 border-3 border-black" />
                        ))}
                    </div>
                </div>
            </div>
